...
const NewAccount = ({ i18n, viteApi, networkType, vcInstance, callContract, setState }: Props) => {
	...
	return (
		<>
			<h6 className="text-2xl">Flashloans Execution</h6>
			
			<div> 
			    <h2 className="text-2xll">Commiting Arbitrage Execution</h2>
			</div>

			<div> 
			    <h2 className="text-2xlll">Warning: This tool is very much brand new and in Beta. Use at your own risk. Flashloans may fail and cost gas fees upon Execution</h2>
			</div>
			...
			<h2 className="text-2xl"> Arbitrage WBNB to ROCKI</h2>
			...
			<h2 className="text-2xl">Arbitrage WBNB to CYT</h2>
			...
			<h2 className="text-2xl">Arbitrage ONT to WBNB</h2>
			...
			<h2 className="text-2xl"> Arbitrage BFG to WBNB</h2>
			...
			<h2 className="text-2xl">Arbitrage WBNB to GMR</h2>
			...
			<h2 className="text-2xl">Arbitrage WBNB to NAUT</h2>
